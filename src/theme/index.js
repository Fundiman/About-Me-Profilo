export default {
	...
	"font": {
		"headline1": "normal 700 80px/1.1 --fontFamily-googlePoppins",
		"headline2": "normal 700 52px/1.2 --fontFamily-googlePoppins",
		"headline3": "normal 700 32px/1.2 --fontFamily-googlePoppins",
		"base": "normal 400 18px/1.5 --fontFamily-sans",
		"lead": "normal 400 20px/1.5 --fontFamily-sans",
		"headline1Lg": "normal 700 50px/1.1 --fontFamily-googlePoppins",
		"headline2Lg": "normal 700 38px/1.2 --fontFamily-googlePoppins",
		"headline3Lg": "normal 600 22px/1.2 --fontFamily-googlePoppins"
	},
	"boxShadow": {
